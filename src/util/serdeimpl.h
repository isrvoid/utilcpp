...
template<typename T>
void* serializevector(void* dest, const void* destEnd, const void* _v) noexcept {
...
template<typename T>
const void* deserializevector(void* sharedDest, const void* src, const void* srcEnd) noexcept {
	...
	*static_cast<decltype(v)*>(sharedDest) = v;
